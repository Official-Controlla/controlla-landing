...
useSchemaOrg([
  ...
  defineWebPage(),
  defineQuestion({
    name: computed(() => t("seo.faq1_q")),
    acceptedAnswer: computed(() => t("seo.faq1_a")),
  }),
  defineQuestion({
    name: computed(() => t("seo.faq2_q")),
    acceptedAnswer: computed(() => t("seo.faq2_a")),
  }),
  defineQuestion({
    name: computed(() => t("seo.faq3_q")),
    acceptedAnswer: computed(() => t("seo.faq3_a")),
  }),
]);
</script>
...
<template>
  <main class="flex flex-col flex-1">
    ...
    >
      <div
        class="absolute inset-0 opacity-20 mesh-gradient"
        aria-hidden="true"
      ></div>
      <div class="default-container relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <header>
              ...
              <h2
                ...
                class="text-4xl md:text-6xl font-bold tracking-tight mb-6"
              >
                {{ $t("approach.title") }}
              </h2>
            </header>
          ...
          >
            <div
              class="absolute inset-0 tech-grid opacity-30"
              aria-hidden="true"
            ></div>
            <div
